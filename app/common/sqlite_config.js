...
const createSucursalTable = () => {
  const sentence = `create table if not exists ${BRANCH_TABLE.NAME} (${BRANCH_TABLE.KEY_1} text primary key not null, ${BRANCH_TABLE.NOMBRE_SUCURSAL} VARCHAR(43) NOT NULL,${BRANCH_TABLE.LATITUD} FLOAT(10) NULL,${BRANCH_TABLE.LONGITUD} FLOAT(10) NOT NULL,${BRANCH_TABLE.USUARIO_CREACION} TEXT NULL,${BRANCH_TABLE.FECHA_CREACION} TEXT NULL,${BRANCH_TABLE.FECHA_MODIFICACION} TEXT NULL ) `;
  // const sentenceIndex = `CREATE INDEX ${CLIENTE_TABLE.INDEX_1} ON ${CLIENTE_TABLE.TABLE_NAME} (${CLIENTE_TABLE.ITEM_6});`
...
const createPortafolioComTable = () => {
  const sentence = `create table if not exists ${COMPLEMENTARY_PORTFOLIO.NAME} (${COMPLEMENTARY_PORTFOLIO.KEY_1} text not null,${COMPLEMENTARY_PORTFOLIO.ID_PRODUCTO} text null,${COMPLEMENTARY_PORTFOLIO.ESTADO_PORTAFOLIO_COMPLEMENTARIO} int null,PRIMARY KEY (${COMPLEMENTARY_PORTFOLIO.KEY_1},${COMPLEMENTARY_PORTFOLIO.ID_PRODUCTO})) `;
  // const sentenceIndex = `CREATE INDEX ${CLIENTE_TABLE.INDEX_1} ON ${CLIENTE_TABLE.TABLE_NAME} (${CLIENTE_TABLE.ITEM_6});`
...
const createPortfolioTable = () => {
  const sentence = `create table if not exists ${PORFOLIO.NAME} (${PORFOLIO.KEY_1} text primary key not null,${PORFOLIO.FOREIGH_KEY_1} TEXT null,${PORFOLIO.FOREIGH_KEY_2} TEXT null)`;
  // const sentenceIndex = `CREATE INDEX ${CLIENTE_TABLE.INDEX_1} ON ${CLIENTE_TABLE.TABLE_NAME} (${CLIENTE_TABLE.ITEM_6});`
  createTable(sentence, PORFOLIO.NAME);
};
