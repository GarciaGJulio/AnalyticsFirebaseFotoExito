...
const createPortafolioTable = () => {
  const sentence = `create table if not exists ${PORTAFOLIO.NAME} (${PORTAFOLIO.KEY_1} text not null, ${PORTAFOLIO.ID_PRODUCTO} TEXT NOT NULL,${PORTAFOLIO.ID_GRUPO_CLIENTE} TEXT NOT NULL,${PORTAFOLIO.TIPO} TEXT NOT NULL,${PORTAFOLIO.ESTADO} BOOLEAN NOT NULL,PRIMARY KEY (${PORTAFOLIO.KEY_1},${PORTAFOLIO.ID_PRODUCTO})) `;
  // const sentenceIndex = `CREATE INDEX ${CLIENTE_TABLE.INDEX_1} ON ${CLIENTE_TABLE.TABLE_NAME} (${CLIENTE_TABLE.ITEM_6});`
