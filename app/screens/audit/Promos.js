import { BackHandler, Image, ImageBackground, ScrollView, StatusBar, StyleSheet, Text, View } from 'react-native';
...
const Promos = ({ navigation }) => {
  ...
  return (
    <View style={styles.container}>
      ...
      <LoaderModal animation={animation} visible={isModalVisible} warning={"Guardando datos en la base, por favor espere . . "} />
