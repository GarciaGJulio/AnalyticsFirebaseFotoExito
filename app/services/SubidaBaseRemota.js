...
export const subidaBaseRemoteTodaAuditoria = async (id_auditoria) => {
  ...
  for (let i = 0; i < promocionData.length; i++) {
    ...
    if (promocionData[i].url_imagen1 === "undefined") { promocionData[i].url_imagen1 = "null" } else if (promocionData[i].url_imagen1 === "null") {
      promocionData[i].url_imagen1 = "null"
    } else {
      console.log("URLProvisional", await SubirAlonedrive(promocionData[i].url_imagen1, promocionData[i].url_imagen1, "" + promocionData[i].id_promocion + "-" + "id_exhibidor"))
      promocionData[i].url_imagen2 = await SubirAlonedrive(promocionData[i].url_imagen1, promocionData[i].url_imagen1, "" + promocionData[i].id_promocion + "-" + "id_exhibidor")

    }
    console.log("objeto  img 2 promocion", promocionData[i].url_imagen2);
    if (promocionData[i].url_imagen2 === "undefined") { promocionData[i].url_imagen2 = "null" } else if (promocionData[i].url_imagen2 === "null") {
      promocionData[i].url_imagen2 = "null"
    } else {
      console.log("URLProvisional", await SubirAlonedrive(promocionData[i].url_imagen2, promocionData[i].url_imagen2, "" + promocionData[i].id_promocion + "-" + "id_exhibidor"))
      promocionData[i].url_imagen2 = await SubirAlonedrive(promocionData[i].url_imagen2, promocionData[i].url_imagen2, "" + promocionData[i].id_promocion + "-" + "id_exhibidor")

    }
    console.log("objeto  img3 promocion", promocionData[i].url_imagen3);
    if (promocionData[i].url_imagen3 === "undefined") { promocionData[i].url_imagen3 = "null" } else if (promocionData[i].url_imagen3 === "null") {
      promocionData[i].url_imagen2 = "null"
    } else {
      console.log("URLProvisional", await SubirAlonedrive(promocionData[i].url_imagen3, promocionData[i].url_imagen3, "" + promocionData[i].id_promocion + "-" + "id_exhibidor"))
      promocionData[i].url_imagen3 = await SubirAlonedrive(promocionData[i].url_imagen3, promocionData[i].url_imagen3, "" + promocionData[i].id_promocion + "-" + "id_exhibidor")
  ...
  for (let i = 0; i < preciadorData.length; i++) {
    ...
    if (preciadorData[i].url_imagen1 === "undefined") { preciadorData[i].url_imagen1 = "null" }
    else if (preciadorData[i].url_imagen1 === "null") {
      preciadorData[i].url_imagen1 = "null"
    } else {
      console.log("id percha1:", "" + preciadorData[i].id_categoria + "-" + preciadorData[i].id_percha)
      console.log("URLProvisional", await SubirAlonedrive(preciadorData[i].url_imagen1, "" + preciadorData[i].id_categoria + "-" + preciadorData[i].id_percha))
      preciadorData[i].url_imagen1 = await SubirAlonedrive(preciadorData[i].url_imagen1, "" + preciadorData[i].id_categoria + "-" + preciadorData[i].id_percha)
    }
    console.log("objeto  img 2 promocion", preciadorData[i].url_imagen2);
    if (preciadorData[i].url_imagen2 === "undefined") { preciadorData[i].url_imagen2 = "null" } else if (preciadorData[i].url_imagen2 === "null") {
      preciadorData[i].url_imagen2 = "null"
    } else {
      console.log("id percha2:", "" + preciadorData[i].id_categoria + "-" + preciadorData[i].id_percha)
      console.log("URLProvisional", await SubirAlonedrive(preciadorData[i].url_imagen2, "" + preciadorData[i].id_categoria + "-" + preciadorData[i].id_percha))
      preciadorData[i].url_imagen2 = SubirAlonedrive(preciadorData[i].url_imagen2, "" + preciadorData[i].id_categoria + "-" + preciadorData[i].id_percha)
    }
    console.log("objeto  img3 promocion", preciadorData[i].url_imagen3);
    if (preciadorData[i].url_imagen3 === "undefined") { preciadorData[i].url_imagen3 = "null" } else if (preciadorData[i].url_imagen3 === "null") {
      preciadorData[i].url_imagen3 = "null"
    } else {
      console.log("id percha3:", "" + preciadorData[i].id_categoria + "-" + preciadorData[i].id_percha)
      console.log("URLProvisional", await SubirAlonedrive(preciadorData[i].url_imagen3, "" + preciadorData[i].id_categoria + "-" + preciadorData[i].id_percha))
      preciadorData[i].url_imagen3 = SubirAlonedrive(preciadorData[i].url_imagen3, "" + preciadorData[i].id_categoria + "-" + preciadorData[i].id_percha)
